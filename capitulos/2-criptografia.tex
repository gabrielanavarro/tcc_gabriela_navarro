...
\end{minipage}
\end{figure}
\footnotetext{Disponível em: \url{http://www.bbc.co.uk/history/topics/enigma}}
\footnotetext{Disponível em: \url{http://www.cryptomuseum.com/crypto/lorenz/sz40/}}
%
...
\footnotetext{Disponível em: \url{http://www.codeproject.com/Articles/21076/Securing-Data-in-NET}}
...
\end{figure} 
\footnotetext{Disponível em: \url{http://cryptodox.com/Block\_cipher\_modes\_of\_operation}}
...
\end{figure} 
\footnotetext{Disponível em:\url{https://www.adayinthelifeof.nl/2010/12/08/encryption-operating-modes-ecb-vs-cbc/}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://crypto.stackexchange.com/questions/2476/cipher-feedback-mode}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://commons.wikimedia.org/wiki/File:Ofb\_decryption.png}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://crypto.stackexchange.com/questions/8151/counter-mode-static-iv-but-different-keys}}
\end{description}
...
\end{figure}
\footnotetext{Disponível em: \url{http://www.eventid.net/show-DocId-19.htm}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://www.ecs.umass.edu/ece/koren/FaultTolerantSystems/simulator/AES-L/help.html}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://www.globalspec.com/reference/81191/203279/2-6-stream-ciphers}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://cryptome.org/a51-bsw.htm}}
...
\end{figure}
\footnotetext{Disponível em: \url{http://blog.cryptographyengineering.com/2012/02/sattelite-phone-encryption-is-terrible.html}}
