...
\end{minipage}
\end{figure}
\footnotetext{http://www.bbc.co.uk/history/topics/enigma}
\footnotetext{http://www.cryptomuseum.com/crypto/lorenz/sz40/}
%
...
\end{figure} 
\footnotetext{$http://cryptodox.com/Block\_cipher\_modes\_of\_operation$}
...
\end{figure} 
\footnotetext{$https://www.adayinthelifeof.nl/2010/12/08/encryption-operating-modes-ecb-vs-cbc/$}
...
\end{figure}
\footnotetext{$http://crypto.stackexchange.com/questions/2476/cipher-feedback-mode$}
...
\end{figure}
\footnotetext{$http://commons.wikimedia.org/wiki/File:Ofb\_decryption.png$}
...
\end{figure}
\footnotetext{$http://crypto.stackexchange.com/questions/8151/counter-mode-static-iv-but-different-keys$}
\end{description}
...
\end{figure}
\footnotetext{$http://www.globalspec.com/reference/81191/203279/2-6-stream-ciphers$}
...
\end{figure}
\footnotetext{$http://cryptome.org/a51-bsw.htm$}
...
\end{figure}
\footnotetext{$http://blog.cryptographyengineering.com/2012/02/sattelite-phone-encryption-is-terrible.html$}
